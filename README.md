# SupertonicTTS 보이스 스타일 추출기 (남성 저음 특화 개조판)

이 저장소는 SupertonicTTS의 공식 스타일 빌더(미공개) 없이, **어떤 WAV 파일에서도 음성 스타일 임베딩을 추출**할 수 있게 안내합니다.
...
- 이 도구를 **비동의 음성 사칭, 보이스 피싱, 사기, 괴롭힘, 명예 훼손, 허위 또는 왜곡된 정치·상업 콘텐츠 생성, 또는 음성 기반 인증 우회**에 사용하지 마십시오.
...
1. WavLM Layer 3 거리를 기준으로 **가장 가까운 프리셋 스타일(M1~M5) 자동 선택**
